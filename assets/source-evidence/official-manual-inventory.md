...
현재 카탈로그는 총 80종이며 팔레트 대상은 53종이다. 그중 정확 품번 프로필은 18종(즉시 결선 13종, geometry·동작 준비 중 5종), 품번 미확정 연습 전용은 35종이다. 정확 품번이 없는 장비는 화면에서 연습 결선만 허용하고 `Prewire` 검증과 승인 결선을 차단한다.
...
| LS ELECTRIC `XBC-DN32H` | `assets/source-evidence/manuals/02_LS_XGB_Hardware_XBC-DR32H_Manual_EN.pdf` | `4C1BBB7C60CC2DC80221B67CFE7AD11CA360C9DB12B7F1B36171CF12C8BF18AA` |
| LS ELECTRIC `XBC-DN60SU` | `assets/source-evidence/manuals/official/LS_XBC_SU_User_Manual_EN_V2.2_202406.pdf` | `5F404565F4C2DC2BAD885831D1AED4A69F1F6F80611042D583EB824848BD782E` |
...
| LS ELECTRIC `XBF-AD04A` / `XBF-AD08A` | `assets/source-evidence/manuals/official/LS_XBF_AD04A_AD08A_Installation_Guide_V4.6.pdf` | `FB725723CDB7A80CBA5E6F1C20D65EC882E2A8F4B37E03FDA2D4B41564CE5C4F` |
| LS ELECTRIC `XBF-DV04A` / `XBF-DC04A` | `assets/source-evidence/manuals/official/LS_XBF_DV04A_DC04A_DC04B_Installation_Guide_V4.9.pdf` | `E2B08A823052E0B5D91C83AE1C9AC2EE38262DE6C4C73FED3C7541DB9BB30334` |
| LS ELECTRIC `XBF-RD04A` | `assets/source-evidence/manuals/official/LS_XBF_RD01A_RD04A_Installation_Guide_V4.4.pdf` | `58BD72771B4C9CD3B4B802BB29AEB7A2488F188B092ABE9FC15AC347A345BC01` |
| LS ELECTRIC `XBF-TC04S` | `assets/source-evidence/manuals/official/LS_XBF_TC04S_Installation_Guide_V4.6.pdf` | `2ED5039CEDBB545934718E5B42ED2CCCB256095EF4D896F90FAB8D07AC4B66E5` |
...
2026-08-22 감사에서는 사용자가 팔레트 편집으로 숨긴 20종을 카탈로그에서 삭제했다. 해당 장비만 사용하던 이미지 18개와 Omron/Phoenix 전용 PDF 4개도 복구 태그에만 남겼다. 남은 정확 프로필 18종은 카탈로그의 `manufacturer`, `partNumber`, `manualReferences`에 문서 경로와 SHA-256을 고정하며 테스트에서 실제 파일 해시를 대조한다.
...
| `XY-MD02` | `assets/source-evidence/manuals/06_XY-MD02_TempHumidity_Modbus_Manual.pdf`, `assets/source-evidence/manuals/06_XY-MD02_Manual_alt.pdf` | 공식 제조사 신원과 공식 배포 출처 미확인. 교육용 유지 |
...
| 릴레이·조작기기 | `PB-1C`, `EMSTOP`, `SEL-2P`, `SEL-3P` |
| 센서 | `PROX-NPN`, `PROX-PNP`, `PHOTO`, `PT100-3W`, `TC-K` |
| 부하 | `SOL-Y`, `LAMP-G`, `LAMP-Y`, `LAMP-W`, `LAMP`, `BUZZER`, `MOTOR-3P` |
| 일반 단자·분배 | `TB4`, `TB8`, `TB10`, `TB20`, `TB30`, `TB-PE-10`, `TB-N-10`, `TB-24V-10`, `TB-0V-10` |
